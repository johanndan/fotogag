  ...
  return (
    <nav className="dark:bg-muted/30 bg-muted/60 shadow dark:shadow-xl z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Reihenfolge: Desktop-Menü (links) → Mobile-Burger (links auf Mobile) → Logo (rechts) */}
        <div className="flex items-center justify-between h-16">
          ...
          {/* Mobile: Burger links (Logo ist weiter unten, dadurch steht es rechts) */}
          <div className="md:hidden flex items-center">
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent
                side="left"
                className="w-[240px] sm:w-[300px] !bg-sidebar !text-sidebar-foreground"
