...
>(
  (
    ...
    return (
      <>
        {/* Desktop-Sidebar (nur ≥ md sichtbar) */}
        <div
          ref={ref}
        ...
        {/* Mobile-Sheet (nur < md sichtbar) */}
        <Sheet open={openMobile} onOpenChange={setOpenMobile}>
          <SheetContent
            data-sidebar="sidebar"
            data-mobile="true"
            side={side}
            className="md:hidden w-[var(--sidebar-width)] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={{ "--sidebar-width": SIDEBAR_WIDTH_MOBILE } as React.CSSProperties}
          >
            {/* A11y: Titel ist Pflicht, aber visuell versteckt */}
