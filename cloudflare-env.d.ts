/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: dc292cda5d8ddbdf015a9280306a572b)
// Runtime types generated with workerd@1.20250803.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_INC_CACHE_KV: KVNamespace;
		NEXT_INC_KV_SESSIONS: KVNamespace;
		EMAIL_FROM: "no-reply@photogag.ai";
		EMAIL_FROM_NAME: "PhotoGag";
		...
		WORKER_SELF_REFERENCE: Fetcher /* photogag-app */;
		ASSETS: Fetcher;
	}
}
